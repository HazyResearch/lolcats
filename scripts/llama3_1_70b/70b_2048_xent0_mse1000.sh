...
export MASTER_HOSTNAME="mk-turbo-02"                         # TODO: set to your nodenames
...
# Stage 1: Attention distillation. ( TODO: change distill_llama_finetune.py hardcoded path to your own. )
srun  torchrun --nnodes 2 --node_rank $SLURM_NODEID --rdzv_id $RANDOM --rdzv_backend c10d --rdzv_endpoint $MASTER_ADDR:$MASTER_PORT --nproc_per_node 8 llama_recipes/distill_llama.py \
