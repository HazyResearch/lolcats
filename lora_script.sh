...
torchrun --nnodes 1 --nproc_per_node 8 llama_recipes/distill_llama.py \
    ...
    --distill_config distill_alpaca_clean_llama3_1_70b_xent0_mse1000_lr1e-2 \
...
# torchrun --nproc_per_node 1 llama_recipes/distill_llama_finetune.py \
#     --model_config distill_llama3_1_405b_lk_smd_wtk64_fd64_w01 \
#     --distill_config distill_alpaca_clean_llama3_1_405b_xent0_mse1000_lr1e-2 \
#     --finetune_config finetune_lora_qkvo_alpaca_clean_llama3_1_405b \
#     --eval_config eval_alpaca_clean \
#     --verbose --replicate 0 --seed 0 \
#     --lk_zero_init --eval_steps 1 \
#     --dataset_chunk_size 384 \
