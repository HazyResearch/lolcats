...
#SBATCH --nodes=3
#SBATCH --nodelist=mk-xii-11,mk-xii-13,mk-xii-19
#SBATCH --gres=gpu:8
...
export MASTER_HOSTNAME="mk-xii-11"
export MASTER_ADDR=$(host $MASTER_HOSTNAME | awk '/has address/ { print $4 }')
export MASTER_PORT=29500
export PYTHONPATH=/home/simarora/code/lolcats/

srun  torchrun --nnodes 3 --node_rank $SLURM_NODEID --rdzv_id $RANDOM --rdzv_backend c10d --rdzv_endpoint $MASTER_ADDR:$MASTER_PORT --nproc_per_node 8 /home/simarora/code/lolcats/llama_recipes/eval_stage_1.py \
