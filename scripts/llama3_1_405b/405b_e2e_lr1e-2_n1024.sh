...
#SBATCH --nodes=4
#SBATCH --nodelist=mk-xii-11,mk-xii-12,mk-xii-13,mk-xii-14  # TODO: set to your nodenames
#SBATCH --gres=gpu:8
...
export MASTER_HOSTNAME="mk-xii-11"                         # TODO: set to your nodenames
...
#     --distill_config llama3_1_405b/rp_distill_llama_405b_xent0_mse1000_lr1e-2 \
#     --finetune_config llama3_1_405b/rp_finetune_llama_40b_qv_hparams \
#     --eval_config eval_alpaca_clean \
#     --verbose --replicate 0 --seed 0 \
#     --lk_zero_init --eval_steps 50 \
...
srun  torchrun --nnodes 4 --node_rank $SLURM_NODEID --rdzv_id $RANDOM --rdzv_backend c10d --rdzv_endpoint $MASTER_ADDR:$MASTER_PORT --nproc_per_node 8 /home/simarora/code/lolcats/llama_recipes/distill_llama_finetune.py \
    ...
    --eval_config eval_alpaca_clean \
    --verbose --replicate 0 --seed 0 \
    --lk_zero_init --eval_steps 100 \
    --dataset_chunk_size 1024 \
    --enable_fsdp --fsdp_activation_checkpointing

# also run with:
# finetune_llama_405b_qkvo_e2_rp
