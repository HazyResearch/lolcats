...
#SBATCH --nodes=3
#SBATCH --nodelist=mk-xii-02,mk-xii-08,mk-xii-13
#SBATCH --gres=gpu:8
...
srun  torchrun --nnodes 3 --node_rank $SLURM_NODEID --rdzv_id $RANDOM --rdzv_backend c10d --rdzv_endpoint $MASTER_ADDR:$MASTER_PORT --nproc_per_node 8 /home/simarora/code/lolcats/llama_recipes/distill_llama.py --model_config distill_llama3_1_70b_lk_smd_wtk64_fd64_w01 --distill_config distill_alpaca_clean_llama3_1_70b_xent0_mse1000_lr1e-2 --finetune_config finetune_lora_qkvo_alpaca_clean_llama3_1_70b --eval_config eval_alpaca_clean --verbose --replicate 0 --seed 0 --lk_zero_init --eval_steps 1 --dataset_chunk_size 384 --enable_fsdp --fsdp_activation_checkpointing
