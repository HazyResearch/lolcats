...
#SBATCH --nodes=3
#SBATCH --nodelist=mk-xii-24,mk-xii-03,mk-xii-18                # TODO: set to your nodenames
#SBATCH --gres=gpu:8
...
export MASTER_HOSTNAME="mk-xii-24"             # TODO: set to your nodenames
...
# Stage 2: LoRa finetuning ( TODO: change the distill_llama.py hardcoded path to your own. )
srun  torchrun --nnodes 3 --node_rank $SLURM_NODEID --rdzv_id $RANDOM --rdzv_backend c10d --rdzv_endpoint $MASTER_ADDR:$MASTER_PORT --nproc_per_node 8 /home/simarora/code/lolcats/llama_recipes/distill_llama.py \
    ...
    --distill_config llama3_1_405b/no_distill_llama3_1_405b \
    --finetune_config llama3_1_405b/no_distill_finetune_405b \
