...
CUDA_VISIBLE_DEVICES=3 python distill_llama.py \
    ...
    --load_distill_checkpoint /home/simarora/code/lolcats/checkpoints/llama3_1_8b/distill_llama_3_8b_lk_smd_wtk64_fd64_w01/dl-d=llama3_1_8b/distill_c4_clean_xent1_mse1000_lr1e-2-m=llama3_1_8b/distill_llama_3_8b_lk_smd_wtk64_fd64_w01-f=llama3_1_8b/finetune_qkvo_c4_clean-s=0-nte=2-se=0-re=800-scl=1024-lzi=1_distill.pt \
