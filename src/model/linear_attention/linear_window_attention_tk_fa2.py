"""
Use FlashAttention2 to compute ground-truth attention outputs
"""
...
from .linear_window_attention_tk_long import flash_attention_2
from .linear_window_attention_tk import LolcatsTKWindowAttention


class LolcatsTKWindowAttentionFA2(LolcatsTKWindowAttention):
    """
