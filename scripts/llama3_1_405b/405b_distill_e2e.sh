...
#SBATCH --nodes=3
#SBATCH --nodelist=mk-xii-19,mk-xii-13,mk-xii-11
#SBATCH --gres=gpu:8
...
srun  torchrun --nnodes 3 --node_rank $SLURM_NODEID --rdzv_id $RANDOM --rdzv_backend c10d --rdzv_endpoint $MASTER_ADDR:$MASTER_PORT --nproc_per_node 8 /home/simarora/code/lolcats/llama_recipes/distill_llama_finetune.py \
    --model_config llama3_1_405b/distill_llama3_1_405b_lk_smd_wtk64_fd64_w01 \
    --distill_config llama3_1_405b/distill_llama_405b_xent1_mse1000_lr1e-2 \
    --finetune_config llama3_1_405b/finetune_llama_405b_qkvo_hparams \
    --load_distill_checkpoint /home/simarora/code/lolcats/checkpoints/distill_llama3_1_405b_lk_smd_wtk64_fd64_w01/distill-dl-d\=distill_alpaca_clean_llama3_1_405b_xent0_mse1000_lr1e-2-m\=distill_llama3_1_405b_lk_smd_wtk64_fd64_w01-f\=finetune_lora_qkvo_alpaca_clean_llama3_1_405b-fac\=1-dcs\=512-se\=0-re\=0-lzi\=1/ \
    --eval_config eval_alpaca_clean \
    --verbose --replicate 0 --seed 0 \
    --lk_zero_init --eval_steps 8 \
    --dataset_chunk_size 512 \
